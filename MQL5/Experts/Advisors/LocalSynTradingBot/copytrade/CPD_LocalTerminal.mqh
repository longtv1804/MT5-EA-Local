...
class CPD_LocalTerminal : public Terminal
{
private:
    Terminal *m_pRemoteTerminal;
    CPD_InOutManager *m_pInOutManager;
...
public:
    CPD_LocalTerminal() : m_pRemoteTerminal(NULL), m_pInOutManager(NULL)
    {
    ...
    void init(CPD_InOutManager* inOutController, Terminal* remoteTerminal)
    {
...
***********************************************************************************/
    void OnRemote_Connecting() override
    {
        ...
        jsonData += "}";
        m_pInOutManager.SendData(ToJson(eCMD_ON_CONNECTED, jsonData));
    }
        ...
        if(trans.type == TRADE_TRANSACTION_DEAL_ADD)
        {
            ...
            else if(entry == DEAL_ENTRY_OUT)
            {
                        ...
                        || info.close_reason == eCLOSE_REASON_SO)
                {
                    ...
                    jsonData += "}";
                    m_pInOutManager.SendData(ToJson(cmd, jsonData));
